...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('cmsplugin_twitter', 'cmsplugin_twitter_twitter')

    def backwards(self, orm):
        db.rename_table('cmsplugin_twitter_twitter', 'cmsplugin_twitter')
    ...
    models = {
        ...
        u'cmsplugin_twitter.twitter': {
            'Meta': {'object_name': 'Twitter', '_ormbases': ['cms.CMSPlugin']},
